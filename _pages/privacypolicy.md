...
By using our service, you agree to the collection and use of information as described in this policy. We do not sell your personal information, and we share it only with the service providers described in this policy as necessary to operate and improve the service.
...
利用者は本サービスを利用することで、本ポリシーに記載されている情報の収集と使用に同意するものとします。当社は利用者の個人情報を販売することはなく、本ポリシーに記載するサービス提供者に対し、本サービスの提供・改善に必要な範囲でのみ共有します。
